...
const LatestNews = () => {
  const newsItems = [
    { text: 'Welcome to the platform — place your bets on Matka markets!', icon: '📢', amount: null },
    { text: 'Check market timings before placing bets.', icon: '⏰', amount: null },
    { text: 'Results are updated in real time — stay tuned!', icon: '🔔', amount: null },
  ];
