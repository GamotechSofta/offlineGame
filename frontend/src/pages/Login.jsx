  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white relative overflow-hidden">
      ...
      <div className="hidden md:flex h-screen overflow-hidden">
        ...
        <div className="w-1/2 h-screen fixed left-0 top-0 overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-6xl font-black text-[#d4af37] tracking-wider">MATKA</h1>
            <p className="text-gray-500 text-lg mt-4">Place your bets &amp; win big</p>
          </div>
        </div>
      ...
      <div className="md:hidden flex flex-col px-4 sm:px-6 py-4 sm:py-6 min-h-screen">
        <div className="relative z-10 w-full max-w-md mx-auto flex flex-col items-center justify-center flex-1">
          ...
          <div className="w-full mb-4 sm:mb-6 flex justify-center">
            <div className="w-full max-w-[200px] sm:max-w-[240px] h-[200px] sm:h-[240px] rounded-lg bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center border border-white/5">
              <h1 className="text-4xl font-black text-[#d4af37] tracking-wider">MATKA</h1>
            </div>
          </div>
