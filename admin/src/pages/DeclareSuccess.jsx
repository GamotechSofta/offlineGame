        ...
        <AdminLayout onLogout={handleLogout} title="Result Declared">
            <div className="w-full min-w-0 max-w-lg mx-auto px-4 sm:px-6 py-8 sm:py-12">
                <div className="rounded-xl border-2 border-green-500/50 bg-green-500/10 p-6 sm:p-8 text-center">
                    ...
                    <h1 className="text-xl sm:text-2xl font-bold text-slate-800 mb-2">Result declared successfully</h1>
                    {marketName && (
                        <p className="text-slate-600 text-sm sm:text-base mb-1 truncate" title={marketName}>{marketName}</p>
                    )}
                    {displayText && (
                        <p className="text-blue-600 font-mono text-sm sm:text-base">{displayText}</p>
                    )}
                </div>

                <p className="text-slate-500 text-sm text-center mt-6 mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <button
                        ...
                        className="px-5 py-3 bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold rounded-xl border border-slate-300 transition-colors"
                    >
                        Dashboard
                    </button>
                </div>
