        ...
        <AdminLayout onLogout={handleLogout} title="Top Winners">
                    ...
                    {loading ? (
                        <div className="text-center py-12">
                            <p className="text-slate-500">Loading winners...</p>
                        </div>
                    ) : (
                                ...
                                winners.map((winner, index) => (
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-slate-500">{winner.userId?.email || ''}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex justify-between">
                                                <span className="text-slate-500">Total Winnings:</span>
                                                <span className="font-semibold text-blue-600">₹{winner.totalWinnings}</span>
                                            </div>
                                            <div className="flex justify-between">
