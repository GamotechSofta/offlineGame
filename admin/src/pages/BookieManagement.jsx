        ...
        <AdminLayout onLogout={handleLogout} title="Bookie Accounts">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-4 sm:mb-6">
                        ...
                        <button
                            ...
                            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-4 rounded-lg transition-colors text-sm sm:text-base"
                        >
                    ...
                    <div className="bg-white rounded-lg overflow-hidden">
                        {loading ? (
                            <div className="p-8 text-center">
                                ...
                                <p className="mt-4 text-slate-500">Loading bookies...</p>
                            </div>
                        ) : bookies.length === 0 ? (
                            ...
                            <table className="w-full min-w-[640px] text-sm sm:text-base">
                                ...
                                <tbody className="divide-y divide-slate-200">
                                    {bookies.map((bookie, index) => (
                                        <tr key={bookie._id} className="hover:bg-slate-50">
                                            <td className="px-6 py-4 whitespace-nowrap text-slate-600">
                                                {index + 1}
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="flex items-center gap-2">
                                                    <span className="font-medium text-slate-800">{bookie.username}</span>
                                                    <button
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-2 rounded-lg bg-red-50 text-red-500 hover:bg-red-50 transition-colors"
                                                        title="Delete"
                                                    >
                                                        <FaTrash size={16} />
                                                    </button>
                    ...
                    <div className="mt-4 sm:mt-6 bg-white rounded-lg p-4 sm:p-6">
                        <h3 className="text-base sm:text-lg font-semibold text-blue-600 mb-3">Bookie Login Information</h3>
                        <div className="text-slate-600 space-y-2 text-sm sm:text-base">
                            <p><strong>Bookie Panel URL:</strong> <code className="bg-slate-100 px-2 py-1 rounded">/bookie</code></p>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2 bg-slate-100 border border-slate-300 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                            required
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    <p className="mt-1 text-xs text-slate-400">Bookies log in with phone + password.</p>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className="w-full px-4 py-2 bg-slate-100 border border-slate-300 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10"
                                            required
                                            minLength={6}
                                ...
                                <div className="flex gap-3 pt-2">
                                    <button
                                        ...
                                        className="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold py-2 px-4 rounded-lg transition-colors"
                                    >
                                        Cancel
                                    </button>
                                    <button
                ...
                <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
                        ...
                        <p className="text-slate-600 mb-4">
                            Are you sure you want to delete the bookie account <strong className="text-slate-800">"{selectedBookie?.username}"</strong>?
                        </p>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/30">
                    <div className="bg-white rounded-xl border border-slate-300 shadow-xl w-full max-w-md">
                        <div className="px-4 py-3 border-b border-slate-200 flex items-center justify-between">
                            <h3 className="text-lg font-semibold text-blue-600">Confirm Suspend/Unsuspend Bookie</h3>
                            <button type="button" onClick={() => { setShowPasswordModal(false); setPendingBookie(null); setSecretPassword(''); setPasswordError(''); }} className="text-slate-500 hover:text-slate-900 p-1">×</button>
                        </div>
                        <form onSubmit={handlePasswordSubmit} className="p-4 space-y-4">
                            ...
                            <div className="flex gap-2 justify-end">
                                <button type="button" onClick={() => { setShowPasswordModal(false); setPendingBookie(null); setSecretPassword(''); setPasswordError(''); }} className="px-4 py-2 rounded-lg bg-slate-200 hover:bg-slate-300 text-slate-800 font-semibold">Cancel</button>
